 ...
 * @author dodih
 */
public class DeleteAlt extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Hapus Data Alternatif");
    ...
    private void btnSubmitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSubmitActionPerformed
        try {
            ...
            int result = st.executeUpdate("DELETE FROM alternatif WHERE id = " + fieldID.getText());
            if (result > 0) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DeleteAlt.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
